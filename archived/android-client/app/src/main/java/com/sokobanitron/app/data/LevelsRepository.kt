package com.sokobanitron.app.data

import android.content.Context
import com.sokobanitron.app.content.LevelSet
import com.sokobanitron.app.data.db.LevelEntity
import com.sokobanitron.app.data.db.LevelSetEntity
import com.sokobanitron.app.data.db.LevelsDatabase
import com.sokobanitron.app.data.db.PuzzleEntity
...
class LevelsRepository(
    ...
    fun recordCompletion(
        level: Level,
        solutionHistory: List<List<com.sokobanitron.app.sokoban.Position>>,
    ): String {
